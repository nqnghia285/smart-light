...
function getAllLight(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (payload !== undefined) {
            ...
            const include = [
                { model: Controller_1.Controller, attributes: ["mcuId", "code", "type"] },
                { model: Room_1.Room, attributes: ["roomId", "name"] },
            ];
            yield models_1.LightModel.findAll({ attributes: attributes, include: include })
                .then((lights) => {
...
exports.getAllLight = getAllLight;
