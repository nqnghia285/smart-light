    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (payload !== undefined) {
            if (payload.role === interface_1.RoleType.ADMIN) {
                ...
                let controller = yield models_1.ControllerModel.findByPk((_a = req.body) === null || _a === void 0 ? void 0 : _a.mcuId);
                if (controller !== null) {
                    yield controller
                        .destroy()
                        .then(() => {
                        ...
                        response.message = `Delete Controler has mcuId:${(_a = req.body) === null || _a === void 0 ? void 0 : _a.mcuId} success`;
                    })
                        .catch((err) => {
